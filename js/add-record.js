...
async function showSuggest(onSave, onReady, accounts, tags) {
  ...
  const CATEGORY_ICONS = {
    ...
    '住居':       { bg:'#F0EDE8', stroke:'#8C7A5C',
      path:'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z' },
    '光熱・水道': { bg:'#F2EEE0', stroke:'#9C8040',
