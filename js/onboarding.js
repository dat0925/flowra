      ...
      <div class="ob-step" data-step="4">
        ...
        <div class="ob-invite-illust">
          <svg width="96" height="64" viewBox="0 0 96 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <!-- 左の人物 -->
            <circle cx="28" cy="18" r="10" fill="#4A7C59"/>
            <path d="M8 54c0-11 9-18 20-18s20 7 20 18" fill="#4A7C59"/>
            <!-- 右の人物 -->
            <circle cx="68" cy="18" r="10" fill="#6FA882"/>
            <path d="M48 54c0-11 9-18 20-18s20 7 20 18" fill="#6FA882"/>
          </svg>
        </div>
