...
export const DB = {
  ...
  // これを基準単価として、Premium原価率70%目標で算出: ¥398×0.7÷¥0.81 ≈ 344回 → 300回に設定。
  // 旧6,000回は「原価¥60〜90/月」という過去の見積りを前提にしていたが、
  // 実際のシステムプロンプト等を含めて再計算した結果、上記の通り単価がそれより高いことが判明した。
  PREMIUM_AI_LIMIT: 300,
